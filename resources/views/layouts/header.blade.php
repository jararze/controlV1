<header
    ...
    <div class="container-fluid flex justify-between items-stretch px-5 lg:ps-0 lg:gap-4" id="header_container">
        <div class="flex items-center mr-1">
            <div class="flex items-center justify-center lg:w-[--tw-sidebar-width] gap-2 shrink-0">
                ...
                <a class="mx-1" href="{{ route('dashboard') }}">
                    <x-application-logo class="min-h-[8px] w-8 h-8 dark:text-white"/>
                </a>
            </div>
        ...
        <div class="flex items-center lg:gap-3.5">
            <a class="btn btn-xs btn-primary mr-1 sm:mr-0" href="#">
                Inicia Carga un archivo
            </a>
            <div class="flex items-center gap-1.5">
                <button class="btn btn-icon btn-icon-lg size-8 text-gray-600 hover:text-primary"
                ...
                <div class="dropdown" data-dropdown="true" data-dropdown-offset="-10px, 10px"
                    ...
                    <button
                        class="dropdown-toggle btn btn-icon btn-icon-lg size-8 text-gray-600 hover:text-primary [dropdown-open:text-primary]">
                                        ...
                                        <div class="menu" data-menu="true">
                                            <div class="menu-item" data-menu-item-offset="0, 10px"
                                                ...
                                                <div class="menu-dropdown menu-default w-full max-w-[175px]"
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link"
                                                           href="html/demo3/account/members/teams.html">
                  <span class="menu-icon">
                  ...
                  <span class="menu-icon">
                   ...
                   <i class="ki-filled ki-right text-3xs rtl:transform rtl:rotate-180">
                                                        ...
                                                        <div class="menu-dropdown menu-default w-full max-w-[175px]">
                                                            <div class="menu-item">
                                                                <a class="menu-link"
                                                                   href="html/demo3/account/members/import-members.html">
                    <span class="menu-icon">
                    ...
                    <span class="menu-icon">
                     ...
                     Group Settings
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link"
                                                           href="html/demo3/account/security/privacy-settings.html">
                  <span class="menu-icon">
           ...
           Enabled
              ...
              Building web expierences
                        ...
                        <div class="grid p-5 border-t border-t-gray-200">
                            <a class="btn btn-sm btn-light justify-center" href="html/demo3/account/api-keys.html">
                                Go to Apps
                            </a>
                        </div>
                    </div>
                ...
                <div class="menu-item" data-menu-item-offset="0px, 9px" data-menu-item-placement="bottom-end"
                    ...
                    <div class="menu-dropdown menu-default light:border-gray-300 w-screen max-w-[250px]">
                        <div class="flex items-center justify-between px-5 py-1.5 gap-1.5">
                            <div class="flex items-center gap-2">
                                <img alt="" class="size-9 rounded-full border-2 border-success"
                                     src="{{ asset("assets/media/avatars/300-2.pn") }}g">
                                <div class="flex flex-col gap-1.5">
                                        <span
                                            class="text-sm text-gray-800 font-semibold leading-none">{{ Auth::user()->name }}</span>
                        ...
                        <div class="flex flex-col">
                            <div class="menu-item">
                                <a class="menu-link" href="#">
                                    <span class="menu-icon"><i class="ki-filled ki-badge"></i></span>
                            ...
                            <div class="menu-item" data-menu-item-offset="-50px, 0"
                                ...
                                <div class="menu-dropdown menu-default light:border-gray-300 w-full max-w-[220px]">
                                    <div class="menu-item">
                                        <a class="menu-link" href="#">
                                            <span class="menu-icon"><i class="ki-filled ki-coffee"></i></span>
                                            <span class="menu-title">Get Started</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="#">
                                            <span class="menu-icon"><i class="ki-filled ki-some-files"></i></span>
                                            <span class="menu-title">My Profile</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="#">
                                            <span class="menu-icon"><i class="ki-filled ki-icon"></i></span>
                                            <span class="menu-title">Billing</span>
                                            <span class="menu-badge" data-tooltip="true" data-tooltip-placement="top"><i
                                                    class="ki-filled ki-information-2 text-md text-gray-500"></i></span>
                                            <span class="tooltip" data-tooltip-content="true">Payment and subscription info</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="#">
                                            <span class="menu-icon"><i class="ki-filled ki-medal-star"></i></span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="html/demo3/account/integrations.html">
                                            <span class="menu-icon"><i class="ki-filled ki-switch"></i></span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="html/demo3/account/security/overview.html">
                                            <span class="menu-icon"><i class="ki-filled ki-shield-tick"></i></span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="https://devs.keenthemes.com">
                                    <span class="menu-icon"><i class="ki-filled ki-message-programming"></i></span>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="menu-item px-4 py-1.5">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <a class="btn btn-sm btn-light justify-center" href="{{ route('logout') }}" onclick="event.preventDefault();
