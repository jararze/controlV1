<x-app-layout>
        ...
        <div class="container-fluid flex items-center justify-between flex-wrap gap-3">
            <div class="flex items-center flex-wrap gap-1 lg:gap-5">
                <h1 class="font-medium text-lg text-gray-900">
                    Procesamiento de Archivos en Curso
                </h1>
            </div>
        </div>
        <!-- End of Container -->
                ...
                <div class="card-body flex flex-col items-center justify-center py-8" id="processing-status">
                    ...
                    <div class="w-full max-w-xl mb-8">
                        <div class="flex justify-between mb-1">
                            <span class="text-sm font-medium text-blue-700">Progreso General</span>
                    ...
                    <div class="w-full max-w-4xl" id="jobs-container">
                        <h3 class="font-medium text-gray-700 mb-3">Archivos en cola de procesamiento:</h3>
                        <div id="no-jobs-message" class="hidden py-4 text-center text-gray-500">
    ...
    <template id="job-template">
        <div class="job-item bg-gray-50 p-4 rounded-lg border border-gray-200">
            <div class="flex justify-between items-start mb-3">
                <div>
                    <h4 class="font-medium text-gray-800 job-type">Tipo de Archivo</h4>
                    <p class="text-sm text-gray-600 job-filename">nombre_del_archivo.csv</p>
                </div>
                <span class="px-2 py-1 text-xs rounded-full job-status bg-blue-100 text-blue-800">En progreso</span>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div>
                    <div class="flex justify-between mb-1">
                        ...
                        <span class="text-xs font-medium text-gray-700 job-progress-text">0%</span>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-x-4 gap-y-2 text-sm mt-2">
                    <div>
                        ...
                        <span class="ml-2 job-started-at">-</span>
                    </div>
                    <div>
                        <span class="text-gray-500">Fin estimado:</span>
                        <span class="ml-2 job-estimated-end">-</span>
                    </div>
                    <div>
                        <span class="text-gray-500">Registros:</span>
                        <span class="ml-2"><span class="job-processed-records">0</span>/<span class="job-total-records">0</span></span>
                    </div>
                    <div>
                        <span class="text-gray-500">Tiempo restante:</span>
                        <span class="ml-2 job-remaining-time">Calculando...</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    if (!data.jobsRunning) {
                        ...
                        jobsContainer.innerHTML = `
                            <div class="py-6 text-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-800 mb-1">¡Procesamiento completado!</h3>
                                <p class="text-gray-600 mb-4">Todos los archivos han sido procesados correctamente.</p>
                                <div class="mt-4">
                                    <p class="text-sm text-gray-500">Redirigiendo en 3 segundos...</p>
                                </div>
                            </div>
                        `;
