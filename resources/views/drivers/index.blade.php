                            ...
                            <table class="table table-border" id="members_table">
                                ...
                                <tr>
                                    <th class="min-w-[180px]">
                                        <span class="sort asc"><span
                                                class="sort-label text-gray-700 font-normal">Placa</span><span
                                    ...
                                    <th class="w-[180px]">
                                        <span class="sort"><span
                                                class="sort-label text-gray-700 font-normal">Celular Conductor</span><span
                                                class="sort-icon"></span></span></th>
                                    <th class="w-[250px]">
                                        <span class="sort"><span
                                                class="sort-label text-gray-700 font-normal">Grupo</span><span
                                                class="sort-icon"></span></span>
                                    </th>
                                    <th class="w-[250px]">
                                        <span class="sort"><span class="sort-label text-gray-700 font-normal">Propietario</span><span
                                                class="sort-icon"></span></span>
                                    </th>
                                    <th class="w-[250px]">
                                        <span class="sort"><span class="sort-label text-gray-700 font-normal">Celular</span><span
                                                class="sort-icon"></span></span>
                                    </th>
                                    <th class="w-[100px]">
                                    </th>
                                ...
                                @foreach($drivers as $result)
                                    <tr class="border-b">
                                        ...
                                        <td>
                                            {{ $result->conductor ? $result->conductor : 'No disponible' }}
                                        </td>
                                        <td>
                                            {{ $result->celular_conductor ? $result->celular_conductor : 'No disponible' }}
                                        </td>
                                        ...
                                        <td class="text-gray-800 font-normal">
                                            {{ $result->cel_propietario ? $result->cel_propietario : 'No disponible' }}
                                        </td>
                                        <td>
                                                ...
                                                <div class="menu-item" data-menu-item-offset="0, 10px"
                                                    ...
                                                    <div class="menu-dropdown menu-default w-full max-w-[175px]"
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link"
                                                               href="#"
{{--                                                               data-url="{{ route('work.matrix.call', ['patente' => $result->placa]) }}"--}}
                                                               data-planilla="{{ $result->placa }}"
                                                            >
