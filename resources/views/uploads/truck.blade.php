        ...
        <div class="grid gap-5 lg:gap-7.5 xl:w-[38.75rem] mx-auto">
            <div class="card pb-2.5">
                <div class="card-header" id="basic_settings">
                    <h3 class="card-title">
                        Subir plana de truck
                    </h3>
                </div>
                <form action="{{ route('uploads.index.truck.post') }}" method="POST" enctype="multipart/form-data" class="card-body grid gap-5" x-data="{ fileName: '' }" @submit="showModal = true">
                    @csrf
